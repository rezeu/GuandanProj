# -*- coding: utf-8 -*-
''' Implement Guandan Judger class
'''
import numpy as np
import collections
...
from rlcard.games.guandan.utils import CARD_RANK_STR, CARD_RANK_STR_INDEX
from rlcard.games.guandan.utils import cards2str, contains_cards
...
class GuandanJudger:
    ...
    def playable_cards_from_hand(current_hand):
        ...
        for i in more_than_3_indexes:
            ...
            for left, right in GuandanJudger.solo_attachments(current_hand, i[0], 1, 2):
                pre_attached = ''
                for j in left:
            ...
            for left, right in GuandanJudger.pair_attachments(cards_count, i[0], 1, 2):
                pre_attached = ''
                for j in left:
        ...
        solo_chain_indexes = GuandanJudger.chain_indexes(non_zero_indexes)
        ...
        pair_chain_indexes = GuandanJudger.chain_indexes(more_than_1_indexes)
        ...
        trio_chain_indexes = GuandanJudger.chain_indexes(more_than_2_indexes)
            ...
            while(l >= 2):
                ...
                while (curr_length < l and curr_length < 6):
                    ...
                    if (curr_length >= 2 and curr_length <= 5):
                        for left, right in GuandanJudger.solo_attachments(current_hand, s, curr_length, curr_length):
                            pre_attached = ''
                            for j in left:
                                pre_attached += CARD_RANK_STR[j]
                            post_attached = ''
                    ...
                    if (curr_length >= 2 and curr_length <= 4):
                        for left, right in GuandanJudger.pair_attachments(cards_count, s, curr_length, curr_length):
                            pre_attached = ''
                            for j in left:
                                pre_attached += CARD_RANK_STR[j] * 2
                            post_attached = ''
    ...
    def calc_playable_cards(self, player):
        ...
        Args:
            player (GuandanPlayer object): object of GuandanPlayer
    ...
    def judge_game(players, player_id):
        ...
        Args:
            players (list): list of GuandanPlayer objects
