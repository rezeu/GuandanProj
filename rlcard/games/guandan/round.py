...
from rlcard.games.guandan import Dealer
from rlcard.games.guandan.utils import cards2str, guandan_sort_card
...
class GuandanRound:
    ...
    def initiate(self, players):
        ...
        '''
        self.dealer.determine_role(players)
        seen_cards = self.dealer.deck[-3:]
        seen_cards.sort(key=functools.cmp_to_key(guandan_sort_card))
